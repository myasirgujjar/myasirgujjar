...
<p align="center">
  ...
  <br/><br/>
  <strong>⚙️ Rust Developer </strong> — designing <strong>concurrent</strong>, <strong>fault-tolerant</strong>, and <strong>blazing-fast</strong> backend systems in  
...
> 🚀 **!Now Migrated Permanetyly to [Gittea 🔗](https://gitea.com/myasir)**  
...
> - Cloud-native backend design (K8s, Docker, gRPC, REST)  
> - Database performance tuning (PostgreSQL, Redis)  
> - Observability, telemetry, and fault-tolerance  
> - Compilers, interpreters, and backend tooling  
...
<!-- Diesel ORM -->
  ...
  <!-- RabbitMQ -->
  <img width="50" height="50" alt="rabbitmq" src="https://github.com/user-attachments/assets/201dc03a-fb6b-458d-9b14-c22a082fca3d" />
...
> **“Fearless Concurrency. Safe Systems. Real Performance.”** ⚙️  
> — building backend infrastructure that scales gracefully and fails safely.
